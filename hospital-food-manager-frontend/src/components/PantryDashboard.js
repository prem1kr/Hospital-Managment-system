...
const PantryDashboard = () => {
    ...
    useEffect(() => {
        const fetchTasks = async () => {
            try {
                const response = await axios.get('https://hospital-managment-system-9p11.onrender.com/api/tasks');
        ...
        const fetchMeals = async () => {
            try {
                const response = await axios.get('https://hospital-managment-system-9p11.onrender.com/api/meals'); // Fetch meals data
        ...
        const fetchDeliveryPersonnel = async () => {
            try {
                const response = await axios.get('https://hospital-managment-system-9p11.onrender.com/api/delivery-personnel');
        ...
        const fetchMealDeliveries = async () => {
            try {
                const response = await axios.get('https://hospital-managment-system-9p11.onrender.com/api/meal-deliveries');
    ...
    const handleAddPersonnel = async () => {
        try {
            const response = await axios.post('https://hospital-managment-system-9p11.onrender.com/api/delivery-personnel', newPersonnel);
    ...
    const handleUpdatePersonnel = async () => {
        try {
            const response = await axios.put(`https://hospital-managment-system-9p11.onrender.com/api/delivery-person nel/${editingPersonnel._id}`, newPersonnel);
    ...
    const handleAddMealDelivery = async () => {
        try {
            const response = await axios.post('https://hospital-managment-system-9p11.onrender.com/api/meal-deliveries', newMealDelivery);
